...
export class DashboardComponent implements OnInit{
  ...
  listProcessosNomesmoEstado:Array<Processos> = new Array<Processos>();
  ngOnInit(){
      ...
      this.getProcessTrab();
      this.getListProcessosNomesmoEstado();
    }
  ...
  getListProcessosNomesmoEstado(){
    this.service.getListProcessosNomesmoEstado().subscribe((data:Processos[])=>{
      this.listProcessosNomesmoEstado = data;
    });
  }
